...
public class DecaParser implements PsiParser, LightPsiParser {
  ...
  public static boolean decl_field_set(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<decl field set>", PROTECTED, TIDENT)) return false;
    boolean r;
  ...
  public static boolean decl_method(PsiBuilder b, int l) {
    ...
    exit_section_(b, m, DECL_METHOD, r);
    return r;
  }
  ...
  public static boolean decl_var_set(PsiBuilder b, int l) {
    ...
    r = r && consumeToken(b, SEMI);
    exit_section_(b, m, DECL_VAR_SET, r);
    return r;
  }
  ...
  // ( ( LEQ | GEQ | GT | LT ) sum_expr | INSTANCEOF returnType )*
  ...
  // OPARENT ( returnType CPARENT OPARENT )? expr | ( READINT | READFLOAT | NEW ident ) OPARENT
  ...
  // OPARENT ( returnType CPARENT OPARENT )? expr
