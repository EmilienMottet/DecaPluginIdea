...
public class DecaListInstImpl extends ASTWrapperPsiElement implements DecaListInst {

  public DecaListInstImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DecaVisitor visitor) {
    visitor.visitListInst(this);
  }
  ...
  @Override
  @NotNull
  public List<DecaInst> getInstList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DecaInst.class);
  }
