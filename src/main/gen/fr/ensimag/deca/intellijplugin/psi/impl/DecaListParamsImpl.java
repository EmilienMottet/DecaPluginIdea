...
public class DecaListParamsImpl extends ASTWrapperPsiElement implements DecaListParams {

  public DecaListParamsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DecaVisitor visitor) {
    visitor.visitListParams(this);
  }
  ...
  @Override
  @NotNull
  public List<DecaParam> getParamList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DecaParam.class);
  }
