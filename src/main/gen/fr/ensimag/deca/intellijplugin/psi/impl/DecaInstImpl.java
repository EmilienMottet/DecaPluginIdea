...
public class DecaInstImpl extends ASTWrapperPsiElement implements DecaInst {

  public DecaInstImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public DecaIfThenElse getIfThenElse() {
    return findChildByClass(DecaIfThenElse.class);
  }
  ...
  public DecaListInst getListInst() {
    return findChildByClass(DecaListInst.class);
  }
