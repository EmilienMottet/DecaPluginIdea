...
public class DecaTypeImpl extends ASTWrapperPsiElement implements DecaType {

  public DecaTypeImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PsiElement getPrimtype() {
    return findChildByType(PRIMTYPE);
  }
